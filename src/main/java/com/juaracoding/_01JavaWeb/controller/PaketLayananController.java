...
Java Developer
Created on 13/03/2023 19:21
@Last Modified 13/03/2023 19:21
Version 1.0
*/

import com.juaracoding._01JavaWeb.configuration.OtherConfig;
import com.juaracoding._01JavaWeb.dto.PaketLayananDTO;
import com.juaracoding._01JavaWeb.model.PaketLayanan;
import com.juaracoding._01JavaWeb.service.PaketLayananService;
...
public class PaketLayananController {
    ...
    @Autowired
    public PaketLayananController(PaketLayananService paketLayananService) {
    ...
    )
    {
        ...
        if((Boolean) objectMapper.get("success"))
        {
            ...
            return "redirect:/api/usrmgmnt/v1/paketLayanan/fbpsb/0/asc/idListHarga?columnFirst=id&valueFirst="+idDataSave+"&sizeComponent=5";//LANGSUNG DITAMPILKAN FOKUS KE HASIL EDIT USER TADI
        }
        else
        {
    ...
    )
    {
        ...
        if((Boolean) objectMapper.get("success"))
        {
            mappingAttribute.setAttribute(model,objectMapper);
            model.addAttribute("paketLayanan",new PaketLayananDTO());
            return "redirect:/api/usrmgmnt/v1/paketLayanan/fbpsb/0/asc/idListHarga?columnFirst=id&valueFirst="+id+"&sizeComponent=5";//LANGSUNG DITAMPILKAN FOKUS KE HASIL EDIT USER TADI
        }
        else
        {
            mappingAttribute.setErrorMessage(bindingResult,objectMapper.get("message").toString());
